...
class AccountController extends BaseController {
	...
	public function postCreate() {
		...
		if ($validator->fails()){
			...
			if($user){
				...
				return Redirect::route('home')
						->with('global','your account has been created, we have sent you an email to confirm.');
			}
		}
	}
	...
	public function getActivate($code){
		...
		if($user->count()){
			...
			if($user->save()){
				return Redirect::route('home')
					->with('global','Successfully activated!you can sign in.');
			}
		}

		return Redirect::route('home')
					->with('global','we cannot activated it.');
	}	
